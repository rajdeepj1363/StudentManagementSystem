...
<form id="admissionForm" action="admission" method="post" enctype="multipart/form-data">
    ...
    <div class="row"><br>
        <div class="col-6 ">
            ...
            <select name="title" id="gender_title">
        ...
        <div class="col-6">
            ...
            <input type="text" name="parent_phone" required><br>
            ...
            <input type="text" name="sub_caste"><br>
    ...
    <div class="tab2">
        ...
        <input type="file" name="up_aadhar" required><br>
        <label>PAN Card</label><span class="required-mark">*</span><br>
        <input type="file" name="up_PAN" required><br>
        <label>10th Marksheet</label><span class="required-mark">*</span><br>
        <input type="file" name="up_tenth" required><br>
        <label>12th Marksheet</label><span class="required-mark">*</span><br>
        <input type="file" name="up_twelve" required><br>
    </div>
    <button class="next" type="button">NEXT</button>
    <button class="submitBtn" type="submit" name="submit" style="display:none;">Submit</button>
</form>
